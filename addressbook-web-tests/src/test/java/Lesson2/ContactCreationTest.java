...
public class ContactCreationTest {
    ...
    public void testAddNewContact() throws Exception {
        ...
        fillContactForm(new ContactData("First Name", "Middle Name", "Last Name", "Nickname", "title", "company", "address", "home", "mobile", "work"));
        submitContactCreation();
        goOnHomePage("home");
    }

    private void goOnHomePage(String home) {
        wd.findElement(By.linkText(home))
                .click();
    }

    private void submitContactCreation() {
        wd.findElement(By.xpath("(//input[@name='submit'])[2]"))
                .click();
    }
